 ...
 * @since 3.0
 */
public class HyperbolaPresentationFactory extends AbstractPresentationFactory {
	...
	public StackPresentation createEditorPresentation(Composite parent,
		...
		return new HyperbolaStackPresentation(parent, site, true, true,
				SWT.HORIZONTAL | SWT.TOP);
	}
	...
	public StackPresentation createViewPresentation(Composite parent,
			IStackPresentationSite site) {
		return new HyperbolaStackPresentation(parent, site, false, true,
				SWT.HORIZONTAL | SWT.TOP);
	}

...
public class ClosePartContributionItem extends ContributionItem {
	private HyperbolaStackPresentation presentation;

	private SelectionAdapter selectionListener = new SelectionAdapter() {
		public void widgetSelected(SelectionEvent e) {
			presentation.close(new IPresentablePart[] { presentation
					.getCurrent() });
		}
	};

	public ClosePartContributionItem(HyperbolaStackPresentation presentation) {

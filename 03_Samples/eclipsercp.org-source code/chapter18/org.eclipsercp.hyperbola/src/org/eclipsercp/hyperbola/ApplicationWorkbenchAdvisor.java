...
public class ApplicationWorkbenchAdvisor extends WorkbenchAdvisor {
	...
	public WorkbenchWindowAdvisor createWorkbenchWindowAdvisor(
		...
		if(useNonRect)
			return new NonRectWorkbenchWindowAdvisor(configurer);
		else 
	...
	public void initialize(IWorkbenchConfigurer configurer) {
		...
		Preferences nonRectPref = new ConfigurationScope().getNode(Application.PLUGIN_ID);
		useNonRect = nonRectPref.getBoolean(GeneralPreferencePage.NON_RECT_WINDOW, false);
	}

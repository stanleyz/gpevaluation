...
public class GeneralPreferencePage extends FieldEditorPreferencePage implements
	...
	public static final String NON_RECT_WINDOW = "prefs_non_rect_window";
	...
	protected void createFieldEditors() {
		...
		addField(boolEditor);
		BooleanFieldEditor nonRectEditor = new BooleanFieldEditor(NON_RECT_WINDOW,
				"Use a non-rectangular window", getFieldEditorParent());
		addField(nonRectEditor);
	}
